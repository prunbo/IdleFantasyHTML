...
| **Skills (18)** | Mining, Woodcutting, Fishing, Thieving, Agility, Firemaking, Smithing, Cooking, Fletching, Crafting, Runecrafting (2×/3× multipliers at 50/75), Prayer, Attack, Strength, Defense, Ranged, Magic, Hitpoints. |
...
| **Quests** | 160 of the app's 189 quests auto-track (gather / craft / kill / dungeon / thieving / prayer families) with claimable rewards. |

### Not in the web edition (yet)

Farming, Herblore, Construction, Mercantile, Slayer, guilds, pets, the Infinite Tower,
carnival, church blessings, and localized strings. The Android app remains the full
experience — this port focuses on the core gather → craft → fight loop.
